                                ...
                                <div class="grid items-end gap-6 mb-6 md:grid-cols-2">
                                    ...
                                    <div class="grid items-end gap-6 mb-6">
                                        <div class="relative">
                                            ...
                                            {{ $form->$field->temporaryUrl() }}
                                            <iframe src="{{ $form->$field->temporaryUrl() }} }}" width="50%" height="600">
                                                This browser does not support PDFs. Please download the PDF to view it: <a href="{{$form->$field->temporaryUrl() }}}}">Download PDF</a>
                                        </iframe>
                                            {{-- <embed src= "{{ $form->$field->temporaryUrl() }}" width= "500" height= "625"> --}}
                                                @else
                                                {{-- {{ URL::asset($form->application->$field) }} --}}
                                                <iframe src="{{ asset($form->application->$field) }}" width="50%" height="600">
                                                    This browser does not support PDFs. Please download the PDF to view it: <a href="{{ asset($form->application->$field) }}">Download PDF</a>
                                            </iframe>
                                                        {{-- <embed src= "{{ asset($form->application->$field) }}" width= "500" height= "625"> --}}
                                                    @endif
                                                @endisset
